...
if (!module.parent){
  ...
  builder(args.length ? args : false, { minify:false }, function (err, content) {
    ...
    fs.write(
        fs.openSync(__dirname + '/../dist/socket.io2.js', 'w')
      , content
      , 0
      , 'utf8'
    );
    console.log('Successfully generated the development build: socket.io2.js');
  });
  ...
  builder(args.length ? args : false, function (err, content) {
    ...
    fs.write(
        fs.openSync(__dirname + '/../dist/socket.io2.min.js', 'w')
      , content
      , 0
      , 'utf8'
    );
    console.log('Successfully generated the production build: socket.io2.min.js');
  });
}
